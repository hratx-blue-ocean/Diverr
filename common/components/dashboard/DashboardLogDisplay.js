      ...
      <Grid className="logDisplay" container item xs={12} spacing={2}>
        <Grid className="logDisplayColumn1" container item xs={8} spacing={2}>
          <Grid className="basicDiveInfo" item xs={12}>
            <Card>
              <Box>Date: {log.date}   Dive Number: {log.id}</Box>
              <Box>{log.dive_site}, {log.city}, {log.country} {'\n'}</Box>
              <Box>{log.dive_center}, {log.dive_instructor}, {log.instructor_cert}</Box>
            </Card>
          </Grid>
        ...
        <Grid className="logDisplayColumn2" container item xs={4} spacing={3}>
          <Grid className="diveConditions" item xs={12}>
            <Card>
              ...
              <Box>Conditions: {log.salt_water? 'Salt-Water' : 'Fresh-Water?'}, {log.boat? 'Boat' : 'No Boat'}, {log.current? 'Current' : 'No Current'}</Box>
            </Card>
          </Grid>
          <Grid className="gear" item xs={12}>
            <Card>
              ...
              <Box>{log.hood? 'Hood, ': 'No Hood,'}{log.gloves? 'Gloves ' : 'No Gloves'}</Box>
              <Box>{log.weight}</Box>
            </Card>
          </Grid>
